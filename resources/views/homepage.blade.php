...
@section('content')
      <div class="h-card">
        ...
        <ul class="social-list">
          <li><i class="fa fa-fw fa-facebook-square"></i> I keep in touch with friends on <a rel="me" href="https://www.facebook.com/jonnybarnes" class="u-url">Facebook</a></li>
          <li><i class="fa fa-fw fa-twitter"></i> I follow people I find interesting on <a rel="me" href="https://twitter.com/jonnybarnes" class="u-url">Twitter</a></li>
          <li><i class="fa fa-fw fa-adn"></i> I geek out on <a rel="me" href="https://alpha.app.net/jonnybarnes" class="u-url">app.net</a></li>
          <li><i class="fa fa-fw fa-google-plus"></i> I exist on <a rel="me" href="https://plus.google.com/117317270900655269082" class="u-url">Google+</a></li>
          <!--<li>I post photos to <a rel="me" href="http://www.flickr.com/photos/22212133@N03/" class="u-url">flickr</a></li>-->
          <li><i class="fa fa-fw fa-github"></i> I push code to <a rel="me" href="https://github.com/jonnybarnes" class="u-url">GitHub</a></li>
          <li><i class="fa fa-fw fa-music"></i> I scrobble songs to <a rel="me" href="https://last.fm/user/jonnymbarnes" class="u-url">last.fm</a> that I listen to on <a rel="me" href="https://open.spotify.com/user/jonnybarnes89" class="u-url">Spotify</a></li>
        </ul>
