...
class NotesController extends Controller {
	...
	public function showNotes()
	{
		...
		/* This raw query worked
		select notes.note, notes.client_id, clients.client_name from notes left join clients on notes.client_id = clients.client_id where notes.id = '80';
		*/
		$notes = Note::where('deleted', '0')
			->orderBy('timestamp', 'desc')
			//->leftJoin('clients', 'notes.client_id', '=', 'clients.client_url')
			->simplePaginate(10);
